...
- Employee hub: organization, login-today marks, profiles, personnel-document placeholders and year-based policy library.
...
Feedback drafts use a dedicated device-only key. Copy or download and share them explicitly, or paste into the private GitHub submission. This static page cannot verify private submissions. Mock approval is not implementation approval. The earlier requirements ledger and its records are unchanged.

The six captioned MP4s and matching VTT files live in videos/. Each uses the same screens and fictional state transitions. They are intentionally silent for group review.

Open policy questions remain visible. Company leave/payroll rules, appraisal formulas, peer-feedback privacy, correction process, role matrix and WhatsApp configuration require approval before implementation.

Only this directory is public. No source audio/transcript, private review records, credentials or employee data may be added.
